...
export async function actualizarFeedCanciones() {
    try {
        ...
        const configuracionRangos = [
            ...
            { id: 'rango-51-200', titulo: '🔉 Populares (50 -200 Likes)', min: 51, max: 200, limite: 10 },
            { id: 'rango-201-500', titulo: '🔊 Hits (200 - 500 Likes)', min: 201, max: 500, limite: 10 },
            { id: 'rango-501-1000', titulo: '📡 Leyendas (500 - 1000 Likes)', min: 501, max: 1000, limite: 15 }
        ];
